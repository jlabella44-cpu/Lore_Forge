...
const LIST_DEFAULT_PROPS = {
  ...
  scenes: Array.from({ length: 5 }, (_, i) => ({
    label: `Book ${i + 1}`,
    image: `data:image/svg+xml;charset=utf-8,${encodeURIComponent(`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1080 1920"><rect width="1080" height="1920" fill="#1a1a24"/><text x="540" y="960" fill="#c2a657" font-size="96" text-anchor="middle" font-family="Georgia,serif">Book ${i + 1}</text></svg>`)}`,
    durationSeconds: 5,
  })),
  captions: [],
  durationSeconds: 29,
